...
class AbaloneGame(object):
    ...
    def features(self, state):
        ...
        black_on_grid = 11-num_black_Off_grid
        white_on_grid = 11-num_white_Off_grid
        num_black_on_edge = 0
        black_average_pos = 0
        num_white_on_edge = 0
        white_average_pos = 0
    ...
    def isEnd(self, state):
        dict_pos, num_black_Off_grid, num_white_Off_grid, player, num_round = state
        if num_white_Off_grid == 5 or num_black_Off_grid == 5 or num_round > self.max_num_rounds:
            return True
        return False
